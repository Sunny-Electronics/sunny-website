...
export const quoteTypes: QuoteTypeDef[] = [
    ...
    fields: [
      {
        ...
        label: "Package",
        type: "select",
        options: ["ATS-49/U", "ATS-25/U", "HC-49/U", "Not sure"],
      },
      {
        name: "frequency",
        label: "Frequency (MHz)",
  ...
  },
  {
    ...
    examples: "SX-32, SX-22, SX-21, SX-8, automotive SX-A series",
    icon: Cpu,
    fields: [
      {
        name: "package",
  ...
  },
  {
    ...
    examples: "SCO-06, SCO-10, SCO-22, SCO-32, SCO-53",
    icon: Timer,
    fields: [
      {
        name: "series",
        label: "Series",
        type: "select",
        options: ["SCO-06", "SCO-10", "SCO-22", "SCO-32", "SCO-53", "Not sure"],
        defaultValue: "SCO-32",
      },
      {
        name: "frequency",
