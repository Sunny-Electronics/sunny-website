...
export default function RequestQuote() {
  ...
  useEffect(() => {
    ...
    const packingSuffix = params.get("packing") === "TR" ? "-T&R" : "";
    const generatedCrystalPart = `S${packageOption.code}${capacitanceValue}${modeValue}${toleranceValue}${tempOption.code}${stabilityOption.code}-${formatMHz(frequencyValue)}${packingSuffix}`;
    const generatedSpec = `${toleranceValue}/${stabilityOption.catalogValue} ${tempOption.label}/${capacitanceValue}pF`;
